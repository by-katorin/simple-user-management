...
<template>
  ...
  <div class="w-full h-full">
    <aside
      ...
      <div>
        <div class="-mx-6 px-6 py-0">
          <div class="shrink-0 flex items-center">
            <Link :href="route('dashboard')">
              <ApplicationLogo class="block h-20 w-auto text-gray-800 mt-1" />
            </Link>
          </div>
        </div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
      <div class="sticky z-10 top-0 h-20 border-b bg-white lg:py-5">
        <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
          <!-- page header -->
          <h6 hidden class="text-lg text-navy-blue font-bold lg:block" v-if="$slots.header">
            <slot name="header" />
          </h6>
          <!--/ page header -->
